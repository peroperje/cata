...
import { GmailJob, JobApplication } from '@cata/shared-types';
import { formatDate } from './date-utils';

interface GmailJobCardProps {
    job: GmailJob;
...
export const GmailJobCard: React.FC<GmailJobCardProps> = ({ 
    job, 
    onToggleUsed, 
    onToggleIrrelevant,
    onLinkApplication,
    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '0.25rem' }}>
                ...
                <span style={{ fontSize: '0.75rem', color: 'rgba(255, 255, 255, 0.7)', whiteSpace: 'nowrap', textAlign: 'right' }}>
